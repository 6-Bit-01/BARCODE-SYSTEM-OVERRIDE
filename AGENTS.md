...
**Current work: Stage B crew/panel handoff and Level 1 controls/readability after merged PR #38.** Main was verified at `0d1882f6b6eebf6fc5704d8a3270f2a6b1fb7354`; the owner said “Merged. Lets proceed.” Read `docs/source-pack/STORY_CONTROLS_PASS.md` and the current CURRENT_STATE/ACCEPTANCE first. The whole-campaign map from #38 is merged. Stage B is implemented as one combined review on `agent/level1-story-controls`: existing-art crew handoff, controller routing, committed crowd behavior, truthful stomp cues, consolidated HUD, follow camera and saved manual calibration. Exact publication/validation is in the generated source manifest. Owner Makko acceptance remains required before merge. Do not restart earlier audits or split this pass into tiny PRs. Next after acceptance: Stage C campaign/save/mixer services.

...
// hands a live Rhythm Mode through the boss cinematic without mutating it.
{
  ...
  const auditedSourceFootRows = {"idle": [308, 308, 308, 308, 308, 308, 308, 308, 308, 308, 308, 308, 308, 308, 308, 308, 308, 308, 308, 308, 308, 308, 308, 308, 308, 308], "walk": [308, 308, 308, 308, 308, 308, 308, 308, 308, 308, 308, 308, 308, 308, 308, 308, 308, 308, 308, 308, 308, 308, 308, 308, 308, 308, 308, 308, 308, 308, 308, 308, 308, 308, 308, 308, 308, 308, 308, 308, 308, 308, 308, 308, 308, 308, 308, 308, 308, 308, 308, 308, 308, 308, 308, 308, 308, 308, 308, 308, 308, 308, 308, 308], "jump": [308, 308, 308, 308, 308, 308, 308, 308, 308, 308, 308, 308, 308, 308, 308, 308, 308, 308, 308, 308, 308, 308, 308, 308, 308, 308, 308], "rhythm": [308, 308, 308, 308, 308, 308, 308, 308, 308, 308, 308, 308, 308, 308, 308, 308, 308, 308, 308, 308, 308, 308, 308, 308, 308, 308, 308, 308, 308, 308, 308, 308, 308, 308, 308, 308, 308, 308, 308, 308, 308, 308, 308, 308, 308, 308, 308, 308]};
...
// Rhythm Mode restrictions, objective completion, and deactivation.
{
  ...
  const airborne = rhythm.show();
  assert(!airborne.ok && airborne.reason === 'land-to-enter' && !rhythm.isActive(), 'Unlocked R waits for landing without changing an airborne player');
  assert(s.window.player.velocity.x === 50 && s.window.player.state === 'jump', 'Rejected airborne entry preserves locomotion and pose');
  ...
  const ok = rhythm.show(); assert(ok.ok && rhythm.isActive() && s.window.player.velocity.x === 0, 'Successful grounded R activation plants the performance stance');

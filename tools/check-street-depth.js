...
w.drawGameEntities({});
assert.deepStrictEqual(order,['props','jammer','hardware','enemy','progression','lostData'],'solid props precede enemies and holograms; lift, rewards and boss keep their later pass');

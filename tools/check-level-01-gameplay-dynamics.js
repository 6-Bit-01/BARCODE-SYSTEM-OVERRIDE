...
function createHarness() {
  ...
  for (const file of ['src/game/comic-hud.js', 'src/game/player.js', 'src/game/enemies.js', 'src/game/hacking.js', 'src/game/lore-records.js', 'src/game/lore-collection.js', 'src/game/lost-data.js', 'src/game/rhythm.js', 'src/game/player-combat.js', 'src/game/sector1-progression.js', 'src/game/update-coordinator.js']) {

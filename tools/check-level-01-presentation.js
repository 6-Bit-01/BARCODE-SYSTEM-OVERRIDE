...

{
  ...
  const target = new w.Enemy(1000, 784, 'virus'); target.entranceComplete = true; Object.assign(target.position, { x: 1000, y: 784 }); target.spawnTimeMs = -10000; target.spawnProtectionDuration = 0; w.enemyManager.enemies = [target];

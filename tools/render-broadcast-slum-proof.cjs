...
proof.state.cameraX = 500; proof.state.messageMs = 0;
capture('02-roof-node');
proof.state.player.x = 1410; proof.state.player.y = 798 - 76;
proof.state.cameraX = 755; proof.state.warning = true;
capture('03-phrase-warning');
proof.state.player.x = 1300; proof.state.player.y = 675 - 76; proof.state.cameraX = 650;

...
assert.strictEqual(images.length, 19, 'restarts/preload reuse nineteen images including wet street and steady jammer');
...
art.preload(); assert.strictEqual(images.length, 19, 'failed assets do not retry forever');

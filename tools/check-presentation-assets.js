...
assert.strictEqual(images.length, 14, 'restarts/preload reuse fourteen images');
...
art.preload(); assert.strictEqual(images.length, 14, 'failed assets do not retry forever');

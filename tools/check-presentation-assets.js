...
assert.strictEqual(images.length, 9, 'restarts/preload reuse nine images');
...
art.preload(); assert.strictEqual(images.length, 9, 'failed assets do not retry forever');

...
assert.strictEqual(images.length, 22, 'restarts reuse the existing images plus cabin, full shaft and cat event atlas');
...
art.preload(); assert.strictEqual(images.length, 22, 'failed assets do not retry forever');

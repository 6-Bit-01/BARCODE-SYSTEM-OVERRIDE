...
assert.strictEqual(images.length, 17, 'restarts/preload reuse seventeen images including lift/flourish/leap');
...
art.preload(); assert.strictEqual(images.length, 17, 'failed assets do not retry forever');

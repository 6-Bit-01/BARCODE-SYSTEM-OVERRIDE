...
(function() {
  ...
  const cacheStreetLifeRoot = 'https://raw.githubusercontent.com/6-Bit-01/BARCODE-SYSTEM-OVERRIDE/5d51f3077d0c1645e0fc69cf25dfce7daa0a592d/';
  ...
  const entries = {
    ...
    cacheStreetDataKiosk: { path: 'assets/cache-road/world/props/street-data-kiosk.webp', root: cacheStreetLifeRoot, columns: 1, rows: 1, frames: 1, ax: .5, ay: 1, smooth: true },
